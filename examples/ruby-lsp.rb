...
# hover
id = client.hover({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb'),
...
# signatureHelp
id = client.signatureHelp({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb'),
...
# references
id = client.references({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb'),
...
id = client.documentSymbol({
    "textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb')})
resp = client.wait_response(id)
puts "resp of documentSymbol"
puts resp

# formatting
id = client.formatting({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb'),
...
# rename
id = client.rename({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb'),
...
# foldingRange
id = client.foldingRange({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb')})
resp = client.wait_response(id)
puts "resp of foldingRange"
puts resp

# codeLens
id = client.codeLens({"textDocument" => LSP::Parameter::TextDocumentIdentifier.new('examples/example.rb')})
resp = client.wait_response(id)
puts "resp of codeLens"
puts resp
